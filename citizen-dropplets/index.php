...
<html lang="en">
    <head>
        ...
        <title><?php echo($page_title); ?> // <?php echo($blog_title); ?></title>
    ...
    <body>
		...
		<div id="container">
			<header id="site">
				<div id="site-logo"><a href="<?php echo($blog_url); ?>" title="<?php echo($blog_title); ?>"><img src="<?php echo($template_dir_url); ?>profile.jpg" /></a></div>
